...
/**
 * Edges function as edges of a network. Edges are static, so all of the
 * Networks share from the same pool; Edges maintain maps of Network specific
 * variables, their weights and states (enabled/disabled);
 */
...
/**
 * The state map contains a boolean (representing enabled or disabled) for each
 * Network in which it is contained
 */
...
/**
 * Disable this Edge in the specified Network. Use this the first time Edge is
 * disabled. The disabler is set to n.
 *
 * @param net
 *            the Network
 * @param n
