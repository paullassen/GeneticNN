...
/**
 * Instantiates a new network. Sets the Population for all later Networks. Use
 * this Contructor for the base Network
 *
 * @param p
 *            the Population
 */
...
/**
 * Mutate. Randomly changes the network by adding a node, adding a connection
...
/**
 * Adds the edge between in and out. Create the Edge if it doesn't exist; Add it
 * from the Population if isn't in the Network Enable it if the Network contains
 * the disbaled Network
 *
 * @param in
 *            the input Node
 * @param out
...
/**
 * This function checks whether the proposed connection loops In other words,
 * checks if the output would affect the input
 * 
 * @param in
 *            the in
 * @param out
