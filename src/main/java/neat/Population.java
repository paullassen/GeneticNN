...
/**
 * Calculates the fitness for each member of the population. Then finds the most
 * fit Networks and puts them in the topFit and sharedTopFit Sets
 */
public void popFitness() {
    ...
    /*
     * Use this for IPoC for(Network network : generation){
...
public void speciate() {
    ...
    /*
     * System.out.println("\nNodeNum: " + Node.count + "\tSpecies: " +
     * thisGeneration.keySet().size() + "\tPopulation: " + generation.size() +
     * "\t Time Since Last: " + (System.currentTimeMillis() - lastTime) /
     * 1000f); lastTime = System.currentTimeMillis();
     */
}
