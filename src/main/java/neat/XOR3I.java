...
public class XOR3I implements FitnessFunction{
	...
	public double calculateFitness(Network net) {
		...
		inList.set(1, 0d);
		inList.set(2, 0d);
		double d2 = net.calculate(inList).get(0);
		inList.set(0, 0d);
		inList.set(1, 0d);
		inList.set(2, 1d);
		...
		inList.set(1, 1d);
		inList.set(2, 0d);
		double d4 = 1d - net.calculate(inList).get(0);
		inList.set(0, 0d);
		inList.set(1, 1d);
		inList.set(2, 1d);
		double d5 = 1d - net.calculate(inList).get(0);
		inList.set(0, 1d);
		inList.set(1, 0d);
		inList.set(2, 0d);
		double d6 = 1d - net.calculate(inList).get(0);
		inList.set(0, 1d);
		inList.set(1, 0d);
		inList.set(2, 1d);
		double d7 = 1d - net.calculate(inList).get(0);
		inList.set(0, 1d);
		inList.set(1, 1d);
		inList.set(2, 0d);
		double d8 = 1d - net.calculate(inList).get(0);
